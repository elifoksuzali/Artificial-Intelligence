...
namespace Teslim.Models
{
    class HOGDescriptor
    {
        ...
        public HOGDescriptor(List<Data> img, int cellWidth, int cellHeight, int blockWidth, int blockHeight, bool signedOrientations = false)
        {
            List<Data> img1 = img;
            CellWidth = cellWidth;
        ...
        internal object Compute(Image<Gray, byte> img)
        {

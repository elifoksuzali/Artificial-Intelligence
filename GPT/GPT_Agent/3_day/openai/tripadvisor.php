...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['textareas'])) {
    ...
    $dosyaYolu = $_SERVER["DOCUMENT_ROOT"] . "api.txt";
...
<form method="post">
    <div class="textarea-container">
        ...
        <textarea name="textareas[]" placeholder="Tur Tipi (Gemi - Uçak - Otobüs - Araç Kiralamaları)"
                  required></textarea><br>
        <textarea name="textareas[]" placeholder="Tur Başlangıç Noktası (Havalimanı)" required></textarea><br>
        <textarea name="textareas[]" placeholder="Gün:(Tur kaç gün sürecek ve dönüş gününü belirterek yazınız)"
                  required></textarea><br>
        <textarea name="textareas[]" placeholder="Şehir/Bölge:(Tur düzenlendiği şehir/ler)" required></textarea><br>
        <textarea name="textareas[]" placeholder="Ziyaret Edilecek Yerler (alanlar,ören yerleri)"
                  required></textarea><br>
